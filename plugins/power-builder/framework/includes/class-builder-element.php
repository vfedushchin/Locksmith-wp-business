...
class Tm_Builder_Element {
	...
	private function _filter_data() {
		...
		if ( isset( $this->advanced_options ) ) {
			$this->advanced_options = apply_filters( 'tm_pb_advanced_options_' . $slug, $this->advanced_options );
		}

		if ( isset( $this->custom_css_options ) ) {
			$this->custom_css_options = apply_filters( 'tm_pb_custom_css_options_' . $slug, $this->custom_css_options );
		}
