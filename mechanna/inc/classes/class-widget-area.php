...
if ( ! class_exists( 'Mechanna_Widget_Area' ) ) {

	class Mechanna_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'mechanna_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'mechanna_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'mechanna_widget_area_classes', $classes, $area_id );
	...
	function mechanna_widget_area() {
		return Mechanna_Widget_Area::get_instance();
	}

	mechanna_widget_area();
}
