 ...
 */
add_filter( 'template_include', array( 'Mechanna_Wrapping', 'wrap' ), 99 );
add_filter( 'mechanna_wrap_base', 'mechanna_wrap_base_cpts' );
 ...
 */
function mechanna_template_path() {
	return Mechanna_Wrapping::$main_template;
}
 ...
 */
function mechanna_template_base() {
	return Mechanna_Wrapping::$base;
}

if ( ! class_exists( 'Mechanna_Wrapping' ) ) {
	...
	class Mechanna_Wrapping {
		...
		/**
		 * Initialize new instance of Mechanna_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'mechanna_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Mechanna_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function mechanna_wrap_base_cpts( $templates ) {
