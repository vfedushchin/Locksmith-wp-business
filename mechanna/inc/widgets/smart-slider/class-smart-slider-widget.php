...
if ( ! class_exists( 'Mechanna_Smart_Slider_Widget' ) ) {

	class Mechanna_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description	= esc_html__( 'Display smart slider on your site.', 'mechanna' );
			$this->widget_id			= 'mechanna_widget_smart_slider';
			$this->widget_name			= esc_html__( 'Smart Slider', 'mechanna' );
			...
			$this->settings 			= array(
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 1,
					'label'				=> esc_html__( 'Posts count', 'mechanna' ),
				),
				'post_title' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display title', 'mechanna' ),
				),
				'content' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display content', 'mechanna' ),
				),
				'more_button' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display more button', 'mechanna' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'mechanna' ),
						'false_toggle'	=> esc_html__( 'Off', 'mechanna' ),
				...
				'more_button_text' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Read more', 'mechanna' ),
					'label'				=> esc_html__( 'More button text', 'mechanna' ),
				...
				'trim_words' => array(
					...
					'min_value'			=> 1,
					'step_value'		=> 1,
					'label'				=> esc_html__( 'Content words trimmed count', 'mechanna' ),
				),
				'width' => array(
					'type'				=> 'text',
					'value'				=> '100%',
					'label'				=> esc_html__( 'Slider width', 'mechanna' ),
				),
				'height' => array(
					'type'				=> 'text',
					'value'				=> '800',
					'label'				=> esc_html__( 'Slider height', 'mechanna' ),
				),
				'orientation' => array(
					'type'				=> 'select',
					'size'				=> 1,
					'value'				=> 'horizontal',
					'options' => array(
						'horizontal'	=> esc_html__( 'Horizontal', 'mechanna' ),
						'vertical'		=> esc_html__( 'Vertical', 'mechanna' ),
					),
					'label'				=> esc_html__( 'Slider orientation', 'mechanna' ),
				),
				'slide_distance' => array(
					...
					'max_value'			=> 100,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Slide distance(px)', 'mechanna' ),
				),
				'slide_duration' => array(
					...
					'min_value'			=> 100,
					'step_value'		=> 100,
					'label'				=> esc_html__( 'Slide duration(ms)', 'mechanna' ),
				),
				'slide_fade' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use fade effect?', 'mechanna' ),
				),
				'navigation' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use navigation?', 'mechanna' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'mechanna' ),
						'false_toggle'	=> esc_html__( 'Off', 'mechanna' ),
				...
				'fade_navigation' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates whether the arrows will fade in only on hover', 'mechanna' ),
				...
				'pagination' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use pagination?', 'mechanna' ),
				),
				'autoplay' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use autoplay?', 'mechanna' ),
				),
				'fullScreen' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display fullScreen button?', 'mechanna' ),
				),
				'shuffle' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates if the slides will be shuffled', 'mechanna' ),
				),
				'loop' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use infinite scrolling?', 'mechanna' ),
				),
				'thumbnails' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails?', 'mechanna' ),
					'toggle'			=> array(
						'true_toggle'	=> esc_html__( 'On', 'mechanna' ),
						'false_toggle'	=> esc_html__( 'Off', 'mechanna' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom'		=> esc_html__( 'Bottom', 'mechanna' ),
						'right'			=> esc_html__( 'Right', 'mechanna' ),
						'left'			=> esc_html__( 'Left', 'mechanna' ),
					),
					'label'				=> esc_html__( 'Sets the position of the thumbnail scroller', 'mechanna' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails arrows?', 'mechanna' ),
					'master'			=> 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'mechanna' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="mechanna-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'mechanna_smart_slider_default_query_args', array(
				'post_type'				=> 'post',
				'orderby'				=> 'date',
				'order'					=> 'DESC',
				'posts_per_page'		=> -1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'mechanna_smart_slider_title_settings', array(
				'width'				=> '100%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'mechanna_smart_slider_content_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '51%%',
				'show_transition'	=> 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'mechanna_smart_slider_more_button_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '58%%',
				'show_transition'	=> 'left',
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$html .= '<div class="smart-slider__item sp-slide">';
					$html .= $this->utility->media->get_image( array(
						'size'			=> 'mechanna-thumb-xl',
						'mobile_size'	=> 'mechanna-thumb-l',
						'class'			=> 'sp-image',
	...
	add_action( 'widgets_init', 'mechanna_register_smart_slider_widgets' );
	function mechanna_register_smart_slider_widgets() {
		register_widget( 'Mechanna_Smart_Slider_Widget' );
	}
}