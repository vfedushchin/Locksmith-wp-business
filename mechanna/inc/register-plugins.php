 ...
 * @package Mechanna
 */
add_action( 'tgmpa_register', 'mechanna_register_required_plugins' );
/**
 ...
 */
function mechanna_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'     => esc_html__( 'Contact Form 7', 'mechanna' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
		array(
			'name'         => esc_html__( 'Cherry Sidebar Manager', 'mechanna' ),
	 ...
	 */
	$config = array(
		'id'           => 'mechanna',                 // Unique ID for hashing notices for multiple instances of TGMPA.
