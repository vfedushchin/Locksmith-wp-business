(function($){
	...
	CherryJsCore.theme_script = {
		...
		smart_slider_init: function( self ) {
			$( '.mechanna-smartslider' ).each( function() {
				var slider = $(this),
		...
		swiper_carousel_init: function ( self ) {
			...
			jQuery('.mechanna-carousel').each( function() {
				var swiper = null,
		...
		subscribe_init: function( self ) {
			CherryJsCore.variable.$document.on( 'click', '.subscribe-block__submit', function( event ){
				...
				var $this       = $(this),
					...
					nonce      = form.find( 'input[name="mechanna_subscribe"]' ).val(),
				...
				$.ajax({
					url: mechanna.ajaxurl,
					type: 'post',
					dataType: 'json',
					data: {
						action: 'mechanna_subscribe',
						mail: mail,
						nonce: nonce
					},
					error: function() {
		...
		main_menu: function ( self, target ) {
			...
			if ( 'undefined' !== typeof mechanna &&
				 'undefined' !== typeof mechanna.labels &&
				 'undefined' !== typeof mechanna.labels[ 'hidden_menu_items_title' ] &&
				 '' !== mechanna.labels.hidden_menu_items_title ) {
				 moreButtonText = mechanna.labels.hidden_menu_items_title;
			}
		...
		to_top_init: function ( self ) {
			if ( $.isFunction( jQuery.fn.UItoTop ) ) {
				$().UItoTop({
					text: mechanna.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
