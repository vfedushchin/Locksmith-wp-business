 ...
 * @return void
 */
function bedentist_meta_author( $context = 'loop', $args = array() ) {
	...
	if ( ! bedentist_is_meta_visible( $meta, $context ) ) {
		return;
	}
 ...
 * @return void
 */
function bedentist_meta_date( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function bedentist_meta_comments( $context = 'loop', $args = array() ) {
	...
	$comments_format = apply_filters(
		'bedentist_meta_comments_format',
 ...
 * @return void
 */
function bedentist_meta_categories( $context = 'loop', $args = array(), $echo = true ) {
	...
	$categories_format = apply_filters(
		'bedentist_meta_categories_format',
 ...
 * @return void
 */
function bedentist_meta_tags( $context = 'loop', $args = array() ) {
 ...
 * @return array
 */
function bedentist_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( 'bedentist_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'bedentist_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'bedentist' ) . $network['name'],
 ...
 * @return bool
 */
function bedentist_is_meta_visible( $meta, $context = 'loop' ) {

	if ( ! $meta ) {
		return false;
	}

	$meta_enabled = get_theme_mod( $meta, bedentist_theme()->customizer->get_default( $meta ) );
