...
add_filter( 'bedentist_wrap_base', 'bedentist_wrap_base_cpts' );
 ...
 */
function bedentist_template_path() {
 ...
 */
function bedentist_template_base() {
...
if ( ! class_exists( '__Tm_Wrapping' ) ) {
	...
	class __Tm_Wrapping {
		...
		public function __toString() {
			$this->templates = apply_filters( 'bedentist_wrap_' . $this->slug, $this->templates );
 ...
 */
function bedentist_wrap_base_cpts( $templates ) {
