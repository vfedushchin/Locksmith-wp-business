...
if ( ! class_exists( '__Tm_About_Widget' ) ) {
	...
	class __Tm_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'bedentist' );
			$this->widget_id          = 'bedentist_widget_about';
			$this->widget_name        = esc_html__( 'About Dentist', 'bedentist' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'bedentist' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'bedentist' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'bedentist' ),
					'value'             => '',
					'label'             => esc_html__( 'Content:', 'bedentist' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'bedentist_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'bedentist_register_about_widget' );
function bedentist_register_about_widget() {
