...
class __Tm_Smart_Slider_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'bedentist widget_smart_slider';
		$this->widget_description = esc_html__( 'Display smart slider on your site.', 'bedentist' );
		$this->widget_id          = 'widget_smart_slider';
		$this->widget_name        = esc_html__( 'Smart Slider Widget', 'bedentist' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Smart Slider', 'bedentist' ),
				'label' => esc_html__( 'Title', 'bedentist' ),
			),
			'terms_type' => array(
				'type'    => 'radio',
				'value'   => 'category',
				'options' => array(
					'category' => array(
						'label' => esc_html__( 'Category', 'bedentist' ),
						'slave' => 'terms_type_category',
					),
					'post_tag' => array(
						'label' => esc_html__( 'Tag', 'bedentist' ),
						'slave' => 'terms_type_post_tag',
					),
				),
				'label' => esc_html__( 'Choose taxonomy type', 'bedentist' ),
			),
			'categories' => array(
				'type'             => 'select',
				'size'             => 1,
				...
				'options'          => false,
				'label'            => esc_html__( 'Select category', 'bedentist' ),
				'multiple'         => true,
				'placeholder'      => esc_html__( 'Select category', 'bedentist' ),
			...
			'tags' => array(
				...
				'options'          => false,
				'label'            => esc_html__( 'Select tags', 'bedentist' ),
				'multiple'         => true,
				'placeholder'      => esc_html__( 'Select tags', 'bedentist' ),
			...
			'posts_per_page' => array(
				...
				'max_value' => 50,
				'min_value' => 1,
				'label'     => esc_html__( 'Posts count', 'bedentist' ),
			),
			'post_title' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display title', 'bedentist' ),
			),
			'content' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display content', 'bedentist' ),
			),
			'more_button' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display more button', 'bedentist' ),
			),
			'more_button_text' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Read more', 'bedentist' ),
				'label' => esc_html__( 'More button text', 'bedentist' ),
			),
			'trim_words' => array(
				'type'       => 'slider',
				'value'      => 15,
				...
				'min_value'  => 1,
				'step_value' => 1,
				'label'      => esc_html__( 'Content words trimmed count', 'bedentist' ),
			),
			'width' => array(
				'type'  => 'text',
				'value' => '100%',
				'label' => esc_html__( 'Slider width', 'bedentist' ),
			),
			'height' => array(
				'type'  => 'text',
				'value' => '800',
				'label' => esc_html__( 'Slider height', 'bedentist' ),
			),
			'orientation' => array(
				'type'    => 'select',
				'size'    => 1,
				'value'   => 'horizontal',
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'bedentist' ),
					'vertical'   => esc_html__( 'Vertical', 'bedentist' ),
				),
				'label' => esc_html__( 'Slider orientation', 'bedentist' ),
			),
			'slide_distance' => array(
				...
				'max_value' => 100,
				'min_value' => 0,
				'label'     => esc_html__( 'Slide distance(px)', 'bedentist' ),
			),
			'slide_duration' => array(
				...
				'min_value'  => 100,
				'step_value' => 100,
				'label'      => esc_html__( 'Slide duration(ms)', 'bedentist' ),
			),
			'slide_fade' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use fade effect?', 'bedentist' ),
			),
			'navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use navigation?', 'bedentist' ),
			),
			'fade_navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'bedentist' ),
			),
			'pagination' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use pagination?', 'bedentist' ),
			),
			'autoplay' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use autoplay?', 'bedentist' ),
			),
			'fullScreen' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display fullScreen button?', 'bedentist' ),
			),
			'shuffle' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates if the slides will be shuffled', 'bedentist' ),
			),
			'loop' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use infinite scrolling?', 'bedentist' ),
			),
			'thumbnails' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails?', 'bedentist' ),
			),
			'thumbnails_arrows' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails arrows?', 'bedentist' ),
			),
			'thumbnails_position' => array(
				...
				'options' => array(
					...
					'bottom' => esc_html__( 'Bottom', 'bedentist' ),
					'right'  => esc_html__( 'Right', 'bedentist' ),
					'left'   => esc_html__( 'Left', 'bedentist' ),
				),
				'label' => esc_html__( 'Sets the position of the thumbnail scroller', 'bedentist' ),
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		if ( $posts_query ) {
			...
			$html = '<h4>' . esc_html__( 'Posts for slider not found', 'bedentist' ) . '</h4>';
		}
	...
	public function render_slider( $posts_query ) {
		...
		$html = '<div class="bedentist-smartslider" ' . $slider_html_attr . '>';
			$html .= '<div id="' . $uniq_id . '" class="bedentist-smartslider__instance slider-pro">';
				$html .= '<div class="bedentist-smartslider__slides sp-slides">';
					$html .= $this->get_slider_loop( $posts_query );
				$html .= '</div>';

				if ( 'true' == $this->instance['thumbnails'] ) {
					$html .= '<div class="bedentist-smartslider__thumbnails sp-thumbnails">';
	...
	public function get_query_slider_items( $query_args = array() ) {
		...
		$defaults_query_args = apply_filters( 'bedentist_smart_slider_default_query_args', array(
			'post_type'      => 'post',
			'orderby'        => 'date',
			'order'          => 'DESC',
			'posts_per_page' => -1,
	...
	public function get_slider_loop( $posts_query ) {
		 ...
		 * @var  array
		 */
		$title_settings = apply_filters( 'bedentist_smart_slider_title_settings', array(
		 ...
		 * @var  array
		 */
		$content_settings = apply_filters( 'bedentist_smart_slider_content_settings', array(
		 ...
		 * @var  array
		 */
		$more_settings = apply_filters( 'bedentist_smart_slider_more_button_settings', array(
		...
		$placeholder_args = apply_filters( 'bedentist_smart_slider_placeholder_args', array(
			'width'  => 1600,
	...
	public function get_slider_thumbnails( $posts_query ) {
		...
		$thumbnail_size = apply_filters( 'bedentist_smart_slider_thumbnail_size', 'bedentist-thumb-240-100', $this->instance );
	...
	public function get_image( $id, $size, $placeholder_attr, $only_url = false ) {
		...
		if ( has_post_thumbnail( $id ) ) {
			...
			$default_placeholder_attr = apply_filters( 'bedentist_smart_slider_placeholder_default_args', array(
				'width'      => 900,
				'height'     => 500,
				'background' => 'eef4fa',
				'foreground' => '298ffc',
...
add_action( 'widgets_init', 'bedentist_register_smart_slider_widgets' );
function bedentist_register_smart_slider_widgets() {
