 ...
 * @return string
 */
function __tm_get_template_part_name(){
...
function __tm_set_post_meta_value( $value ) {
	...
	$curr_opions = '__tm_' . str_replace( 'theme_mod_', '', current_filter() );
 ...
 * @return string
 */
function __tm_get_thumbnail_size() {
	$layout = get_theme_mod( 'blog_layout_type', __tm_theme()->customizer->get_default( 'blog_layout_type' ) );
