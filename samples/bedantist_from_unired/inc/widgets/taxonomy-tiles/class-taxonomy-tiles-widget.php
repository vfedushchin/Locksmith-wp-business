...
if ( ! class_exists( '__Tm_Taxonomy_Tiles_Widget' ) ) {
	...
	class __Tm_Taxonomy_Tiles_Widget extends Cherry_Abstract_Widget {
		 ...
		 * @return string
		 */
		public function get_term_image( $term, $image_size = '__tm-thumb-550', $image_mobile_size = '__tm-thumb-270', $image_type = 'img' ) {
			...
			if ( $id ) {
				...
				$placeholder_attr = apply_filters( '__tm_taxonomy_tiles_widget_placeholder_default_args', array(
					'width'			=> $size_array['width'],
					'height'		=> $size_array['height'],
					'background'	=> $this->hex_to_string( get_theme_mod( 'regular_accent_color_1', __tm_theme()->customizer->get_default( 'regular_accent_color_1' ) ) ),
					'foreground'	=> $this->hex_to_string( get_theme_mod( 'regular_accent_color_2', __tm_theme()->customizer->get_default( 'regular_accent_color_2' ) ) ),
		...
		public function widget( $args, $instance ) {
			...
			if ( isset( $terms ) && $terms ) {
				$image_size        = apply_filters( '__tm_taxonomy_tiles_widget_size', '__tm-thumb-550', $this->instance );
				$image_mobile_size = apply_filters( '__tm_taxonomy_tiles_widget_size_mobile', '__tm-thumb-270', $this->instance );
				...
				echo apply_filters( '__tm_taxonomy_tiles_widget_before',
				...
				echo apply_filters( '__tm_taxonomy_tiles_widget_after', '</div>', $this->instance );
			}
