...
class __Tm_Instagram_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = esc_html__( 'Instagram', '__tm' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance['client_id'] ) ) {
			return print $args['before_widget'] . esc_html__( 'Please, enter your Instagram CLIENT ID.', '__tm' ) . $args['after_widget'];
		}

		if ( empty( $instance['tag'] ) ) {
			return print $args['before_widget'] . esc_html__( 'Please, enter #hashtag.', '__tm' ) . $args['after_widget'];
		}
		...
		if ( ! $photos ) {
			return print $args['before_widget'] . esc_html__( 'No photos. Maybe you entered a invalid CLIENT ID or hashtag.', '__tm' ) . $args['after_widget'];
		}
