...
class __Tm_Smart_Slider_Widget extends Cherry_Abstract_Widget {
	...
	public function get_slider_loop( $posts_query ) {
		...
		$placeholder_args = apply_filters( '__tm_smart_slider_placeholder_args', array(
			'width'  => 1600,
	...
	public function get_slider_thumbnails( $posts_query ) {
		...
		$thumbnail_size = apply_filters( '__tm_smart_slider_thumbnail_size', '__tm-thumb-240-100', $this->instance );
	...
	public function get_image( $id, $size, $placeholder_attr, $only_url = false ) {
		...
		if ( has_post_thumbnail( $id ) ) {
			...
			$default_placeholder_attr = apply_filters( '__tm_smart_slider_placeholder_default_args', array(
				'width'      => 900,
				'height'     => 500,
				'background' => 'eef4fa',
				'foreground' => '298ffc',
