 ...
 * @return void
 */
function __tm_header_time_message( $format = '%s' ) {
	$message = get_theme_mod( 'header_time_text', __tm_theme()->customizer->get_default( 'header_time_text' ) );
 ...
 * @return void
 */
function __tm_header_phone_message( $format = '%s' ) {
	$message = get_theme_mod( 'header_phone_text', __tm_theme()->customizer->get_default( 'header_phone_text' ) );
...
function __tm_top_search( $format = '%s' ) {
	$is_enabled = get_theme_mod( 'header_search', __tm_theme()->customizer->get_default( 'header_search' ) );
...
function __tm_social_list( $context = '', $type = 'icon' ) {
	$visibility_in_top_panel = get_theme_mod( 'top_panel_social_links', __tm_theme()->customizer->get_default( 'top_panel_social_links' ) );
...
function __tm_is_top_panel_visible() {
	...
	$message = get_theme_mod( 'top_panel_text', __tm_theme()->customizer->get_default( 'top_panel_text' ) );
	$social = get_theme_mod( 'top_panel_social_links', __tm_theme()->customizer->get_default( 'top_panel_social_links' ) );
	$menu    = has_nav_menu( 'top' );

	$conditions = apply_filters( '__tm_top_panel_visibility_conditions', array( $message, $social, $menu ) );
