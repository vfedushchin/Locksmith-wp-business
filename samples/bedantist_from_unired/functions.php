	...
	class __Tm_Theme_Setup {
		...
		public function includes() {
			...
			if ( ! is_admin() ) {
				...
				require_once trailingslashit( __TM_THEME_DIR ) . 'inc/template-post.php';
			 ...
			 * Widgets.
			 */
			require_once trailingslashit( __TM_THEME_WIDGETS ) . 'about-author-widget/class-about-author-widget.php';
			...
			require_once trailingslashit( __TM_THEME_WIDGETS ) . 'tm-carousel-widget/class-tm-carousel-widget.php';
			require_once trailingslashit( __TM_THEME_WIDGETS ) . 'tm-smart-slider-widget/class-tm-smart-slider-widget.php';
			require_once trailingslashit( __TM_THEME_WIDGETS ) . 'subscribe-follow-widget/class-subscribe-follow-widget.php';
			require_once trailingslashit( __TM_THEME_WIDGETS ) . 'instagram/class-instagram-widget.php';
				...
				'fields'        => array(
					'__tm_sidebar_position' => array(
						...
						'options'       => array(
							...
							'two-sidebars' => array(
								'label'   => esc_html__( '2 sidebars', '__tm' ),
								'img_src' => trailingslashit( __TM_THEME_URI ) . 'assets/images/admin/page-layout-both-sidebar.svg',
							),
							'fullwidth' => array(
		...
		public function enqueue_admin_assets() {
			wp_enqueue_script( '__tm-admin-script', __TM_THEME_JS . '/admin.min.js', array( 'cherry-js-core' ), __TM_THEME_VERSION, true );
		}
		...
		public function register_assets() {
			wp_register_script( 'jquery-slider-pro', __TM_THEME_JS . '/jquery.sliderPro.min.js', array( 'jquery' ), '1.2.4', true );
			wp_register_script( 'jquery-swiper', __TM_THEME_JS . '/swiper.jquery.min.js', array( 'jquery' ), '3.3.0', true );
			wp_register_script( 'magnific-popup', __TM_THEME_JS . '/jquery.magnific-popup.min.js', array( 'jquery' ), '1.0.1', true );
			wp_register_script( 'jquery-stickup', __TM_THEME_JS . '/jquery.stickup.min.js', array( 'jquery' ), '1.0.0', true );
			wp_register_script( 'jquery-totop', __TM_THEME_JS . '/jquery.ui.totop.min.js', array( 'jquery' ), '1.2.0', true );
			wp_register_script( 'jquery-isotope', __TM_THEME_JS . '/jquery.isotope.min.js', array( 'jquery' ), '4.0.0', true );

			wp_register_style( 'jquery-slider-pro', __TM_THEME_CSS . '/slider-pro.min.css', array(), '1.2.4' );
			wp_register_style( 'jquery-swiper', __TM_THEME_CSS . '/swiper.min.css', array(), '3.3.0' );
			wp_register_style( 'magnific-popup', __TM_THEME_CSS . '/magnific-popup.min.css', array(), '1.0.1' );
			wp_register_style( 'font-awesome', __TM_THEME_CSS . '/font-awesome.min.css', array(), '4.5.0' );
			wp_register_style( 'material-icons', __TM_THEME_CSS . '/material-icons.min.css', array(), '2.1.0' );
		}
		...
		public function enqueue_assets() {
			wp_enqueue_style( '__tm-theme-style', get_stylesheet_uri(), array( 'font-awesome', 'material-icons', 'magnific-popup' ), __TM_THEME_VERSION );
			 ...
			 * @var   array
			 */
			$depends = apply_filters( '__tm_theme_script_depends', array( 'cherry-js-core', 'hoverIntent' ) );
