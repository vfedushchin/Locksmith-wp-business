		...
		*/
		...
		public function get_terms( $args = array() , $ID = 0 ) {
			...
			$default_args = array(
				'visible'	=> 'true',
				'type'		=> 'category',
				'icon'		=> apply_filters( 'cherry_terms_icon', '<i></i>' ),
				'prefix'	=> '',
				'delimiter'	=> ' ',
		...
		public function get_author( $args = array() , $ID = 0 ) {
			...
			$default_args = array(
				'visible'	=> 'true',
				'icon'		=> apply_filters( 'cherry_author_icon', '<i>&mdash;&nbsp;&nbsp;</i>' ),
				'prefix'	=> '',
				'title'		=> '',
				'class'		=> 'post-author',
		...
		public function get_comment_count( $args = array() , $ID = 0 ) {
			...
			$default_args = array(
				'visible'	=> 'true',
				'icon'		=> apply_filters( 'cherry_comment_icon', '<i class="material-icons">mode_comment</i>' ),
				'prefix'	=> '',
		...
		public function get_date( $args = array() , $ID = 0 ) {
			...
			$default_args = array(
				'visible'	=> 'true',
				'icon'		=> apply_filters( 'cherry_date_icon', '<i></i>' ),
				'prefix'	=> '',
				'title'		=> '',
				'class'		=> 'post-date',
