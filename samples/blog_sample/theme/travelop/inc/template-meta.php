 ...
 * @return void
 */
function travelop_meta_author( $context = 'loop', $args = array() ) {
	...
	if ( ! travelop_is_meta_visible( $meta, $context ) ) {
		return;
	}
 ...
 * @return void
 */
function travelop_meta_date( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function travelop_meta_comments( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function travelop_meta_categories( $context = 'loop', $args = array(), $echo = true ) {
	...
	$categories_format = apply_filters(
		'travelop_meta_categories_format',
 ...
 * @return void
 */
function travelop_meta_tags( $context = 'loop', $args = array() ) {
 ...
 * @return array
 */
function travelop_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( 'travelop_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'travelop_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'travelop' ) . $network['name'],
 ...
 * @return bool
 */
function travelop_is_meta_visible( $meta, $context = 'loop' ) {

	if ( ! $meta ) {
		return false;
	}

	$meta_enabled = get_theme_mod( $meta, travelop_theme()->customizer->get_default( $meta ) );
