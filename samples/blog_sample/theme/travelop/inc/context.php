 ...
 * @return void
 */
function travelop_header_class( $classes = array() ) {
	$classes[] = 'site-header';
	$classes[] = get_theme_mod( 'header_layout_type' );
	echo travelop_get_container_classes( $classes );
}
 ...
 * @return void
 */
function travelop_content_class( $classes = array() ) {
 ...
 * @return void
 */
function travelop_footer_class( $classes = array() ) {
	$classes[] = 'site-footer';
 ...
 * @return string
 */
function travelop_get_container_classes( $classes ) {
 ...
 * @return void
 */
function travelop_primary_content_class( $classes = array() ) {
	echo travelop_get_layout_classes( 'content', $classes );
}
 ...
 * @return void
 */
function travelop_sidebar_class( $classes = array() ) {
	echo travelop_get_layout_classes( 'sidebar', $classes );
}
 ...
 * @return string
 */
function travelop_get_layout_classes( $layout = 'content', $classes = array() ) {
	...
	$layout_classes = ! empty( travelop_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] ) ? travelop_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] : array();
	...
	$layout_classes = apply_filters( "travelop_{$layout}_classes", $layout_classes );
 ...
 * @return string|void
 */
function travelop_posts_list_class( $classes = array(), $echo = true ) {
	$layout_type      = get_theme_mod( 'blog_layout_type', travelop_theme()->customizer->get_default( 'blog_layout_type' ) );
	$sidebar_position = get_theme_mod( 'sidebar_position', travelop_theme()->customizer->get_default( 'sidebar_position' ) );
	...
	foreach ( $sidebars as $sidebar ) {
		if ( travelop_widget_area()->is_active_sidebar( $sidebar ) ) {
			$has_sidebars = true;
		}
	}
	...
	$classes = apply_filters( 'travelop_posts_list_class', $classes );
