...
if ( ! class_exists( 'Travelop_Widget_Area' ) ) {

	class Travelop_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'travelop_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'travelop_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'travelop_widget_area_classes', $classes, $area_id );
	...
	function travelop_widget_area() {
		return Travelop_Widget_Area::get_instance();
	}

	travelop_widget_area();
}
