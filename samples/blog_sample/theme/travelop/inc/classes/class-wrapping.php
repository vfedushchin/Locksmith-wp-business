 ...
 */
add_filter( 'template_include', array( 'Travelop_Wrapping', 'wrap' ), 99 );
add_filter( 'travelop_wrap_base', 'travelop_wrap_base_cpts' );
 ...
 */
function travelop_template_path() {
	return Travelop_Wrapping::$main_template;
}
 ...
 */
function travelop_template_base() {
	return Travelop_Wrapping::$base;
}

if ( ! class_exists( 'Travelop_Wrapping' ) ) {
	...
	class Travelop_Wrapping {
		...
		/**
		 * Initialize new instance of Travelop_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'travelop_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Travelop_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function travelop_wrap_base_cpts( $templates ) {
